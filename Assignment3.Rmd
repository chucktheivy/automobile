...
forloop_plot = ggplot(AllSpeeds2, aes(carweights,power,fill=carweights))+geom_boxplot()+ggtitle("For Loop Method")
...
# assign x and y values to dataframe to help create a boxplot
AllSpeedsPur2 = AllSpeedsPur %>% pivot_longer(cols=everything(), names_to="car", values_to="power")



# create pmap boxplot
pmap_plot = ggplot(AllSpeedsPur2, aes(car,power, fill=car))+geom_boxplot()+ggtitle("pmap method")
